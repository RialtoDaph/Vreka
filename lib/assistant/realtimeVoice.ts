...
// the dedicated "GPT real-time" toolbar button on Memory Map. This bypasses
// Vreka's own /api/assistant/speak and /api/assistant/transcribe entirely
// (those back the regular Claude + ElevenLabs voice loop) -- once connected,
// mic audio flows straight to OpenAI and its spoken reply flows straight
// back over WebRTC media, with no server round-trip per turn.
//
