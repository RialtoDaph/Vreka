...
- **Aslan** — asisten AI personal bertenaga Claude, dengan pilihan tier
  ...
  ngobrol suara real-time (OpenAI Realtime API, kalau `OPENAI_API_KEY`
  di-set) -- mesin suara beda dari mode telepon utama, tapi di luar jalur
  data-mutating Aslan, cuma obrolan, kalau
